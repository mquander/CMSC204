...
public class PasswordCheckerTest {
	...
	{
		try{
			assertTrue(PasswordCheckerUtility.isValid("abcABC12"));
			PasswordCheckerUtility.isValid("abc12");
	...
	{
		try{
			assertTrue(PasswordCheckerUtility.isValid("1234567aA"));
			PasswordCheckerUtility.isValid("1234567a");
	...
	{
		try{
			assertEquals(true,PasswordCheckerUtility.isValid("1234aaAA"));
	...
	public void testIsValidPasswordInvalidSequence()
	{
		try{
			assertEquals(true,PasswordCheckerUtility.isValid("1234aaAA"));
			PasswordCheckerUtility.isValid("1234aAAA");
